...
public class Product {
	...
	public String toString() {
		return "Product [fund_shortName=" + fund_shortName + ", fundCompany=" + fundCompany + ", nav=" + nav
				+ ", price_date=" + price_date + ", cumulative_nav=" + cumulative_nav + ", yearNav=" + yearNav
	...
	public Product(String fund_shortName, String fundCompany, Double nav, String price_date, Double cumulative_nav,
