 ...
 *
 */
public class JsonGenFOFFund {
	
	public static List<FOFFund> jsonGetFOFFund(String json){
		 // 
		 ...
		 //封装进一个集合
		//使用集合括起来
		List<FOFFund> threeMonths = new ArrayList<FOFFund>();
      
		
       for(Map<String, Object> m:list){
    	   FOFFund threeMonth = new FOFFund();
