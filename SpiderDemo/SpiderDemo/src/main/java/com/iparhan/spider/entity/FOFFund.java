...
public class FOFFund {
	...
	public String toString() {
		return "FOFFund [fund_short_name=" + fund_short_name + ", newest_nav=" + newest_nav + ", estabilishTime="
				+ estabilishTime + ", thisYear_nav=" + thisYear_nav + ", top_rate=" + top_rate + ", fundManager="
				+ fundManager + ", fundCompany=" + fundCompany + "]";
	}
	public FOFFund(String fund_short_name, Double newest_nav, String estabilishTime, Double thisYear_nav,
