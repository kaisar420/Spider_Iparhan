...
public class OverSeasFund {
	...
	public String toString() {
		return "OverSeasFund [id=" + id + ", fund_shortName=" + fund_shortName + ", fundCompany=" + fundCompany
				+ ", nav=" + nav + ", cumulative_nav=" + cumulative_nav + ", price_date=" + price_date + ", yearNav="
	...
	public OverSeasFund(String id, String fund_shortName, String fundCompany, Double nav, Double cumulative_nav,
			...
			Double top2018, Double top2017, Double top2016, Double top2015, Double top2014, Double top2013,
			Double top2012, Double top2011) {
		super();
		this.id = id;
		this.fund_shortName = fund_shortName;
		this.fundCompany = fundCompany;
