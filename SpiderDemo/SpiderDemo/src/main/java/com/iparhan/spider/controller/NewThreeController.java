...
import com.iparhan.spider.dao.MysqlNewThree;
...
import com.iparhan.spider.utils.JsonGetNewThree;

import net.sf.json.JSONArray;
import net.sf.json.JSONObject;

@RestController
public class NewThreeController {
	
	//返回标志
		public static final String succes = "SUCCESS";
		//目标网址
		public String newThreeFund_2 = "";
		
		@RequestMapping(value="/newThreeFund")
		public String spiderCompany(String username, String message) throws ClientProtocolException, IOException, SQLException{
			...
			//HTTPGET
			HttpGet httpGet = new HttpGet(newThreeFund_2);
			...
			//爬取的数据存储本地
			String fileName = "newThreeFund_2";
			...
			List<NewThreeFund> jsonArray2 = JsonGetNewThree.jsonGetNewThreeFund(jsonArray);
			System.out.println("三月牛基输出吧"+jsonArray2);
			MysqlNewThree.executeUpdateNewThree(jsonArray2);
