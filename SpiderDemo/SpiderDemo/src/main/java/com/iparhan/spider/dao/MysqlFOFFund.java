...
public class MysqlFOFFund {
	 ...
	 * @throws SQLException
	 */
	public static void executeUpdateFOFFund(List<FOFFund> data) throws SQLException {
		...
		try{
			qr.batch("insert into t_spi_foffund(fund_short_name,newest_nav,estabilishTime,thisYear_nav,top_rate,fundManager,fundCompany) values (?,?,?,?,?,?,?)", params);
