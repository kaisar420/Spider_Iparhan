...
public class MysqlOverSeasFund {
	 ...
	 * @throws SQLException
	 */
	public static void executeUpdateOverSeasFund(List<OverSeasFund> data) throws SQLException {
		...
		try{
			qr.batch("insert into t_spi_overseasFund(fund_shortName,fundCompany,nav,price_date,cumulative_nav,yearNav,sharperPercent,profit_col5,topOneMonth,topThreeMonth,topHalfYear,topOne,topTwo,topThree,topFive,top2018,top2017,top2016,top2015,top2014,top2013,top2012,top2011) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", params);
